  ...
  <section>
    ...
    <section>
      ...
      <ResizablePresenter>
        ...
        <ResizablePresenterBox minWidth="30rem" minHeight="12rem" title="standard - with home link" withFoam="vertical">
          <Nav style={{ zIndex: "0" }} mode="horizontal">
            <NavZone>
              <NavLinkHome
                src={logoButton}
    ...
    <section>
      ...
      <IframePresenter>
        <IFramePresenterBox
          src={`${global.window && window.location.origin}/framed/demo-navigation/horizontal`}
